...
RSpec.describe 'admin/subscription_products/new', type: :view do
  before(:each) do
    assign(:admin_subscription_product, Admin::SubscriptionProduct.new(
                                          lock_version: 1,
                                          name: 'MyString',
                                          description: 'MyText',
  ...
  it 'renders new admin_subscription_product form' do
    render

    assert_select 'form[action=?][method=?]', admin_subscription_products_path, 'post' do
